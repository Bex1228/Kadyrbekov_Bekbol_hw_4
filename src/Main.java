...
public class Main {
    ...
    public static int[] heroesHealth = {270, 280, 250, 400, 700, 250, 320, 200};
    ...
    public static void berserkReturnDamage() {    //метод берсерка
        int berserkIndex = 6;
    ...
    public static void golem() {     //метод голема
    ...
    public static void thorStun() {    //метод тора
        Random random = new Random();
    ...
    public static void luckyLuck() {    //метод лаки
        Random random = new Random();
    ...
    public static void medicHeal() {   //метод врача
        int healPoint = 100;
